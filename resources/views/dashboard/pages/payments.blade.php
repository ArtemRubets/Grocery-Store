                    ...
                    <form method="POST" action="{{ route('dashboard.payments.setPaymentsSettings') }}">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <select class="form-control" id="defaultCurrency" name="default-currency" required>
...
{{--                        </div>--}}
                        <hr class="mb-4">
                        <button class="btn btn-primary btn-lg btn-block" type="submit">Apply settings</button>
                    </form>
                </div>
            </div>
        </div>
